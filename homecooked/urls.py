...
urlpatterns = [
    ...
    # path('dishes/<int:pk>/add_to_cart', views.add_dish_to_cart, name='add_dish_to_cart'),
    path('order/add_to_cart', views.add_dish_to_cart, name='add_dish_to_cart'),
    path('order/<int:pk>', views.view_orders, name='view_orders'),
